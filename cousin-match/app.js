...
App:       Cousin Image Match
Version:   1.0.0
Author:    Andrew Campbell
Created:   12 June 2026

Description:
Children match the Cousin image cards to the correct Memory Spot number.
...
function imagePath(num) {
  return `../assets/cousins/CT_img_${String(num).padStart(2, "0")}_Back.png`;
}
